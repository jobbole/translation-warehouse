...
程序员的世界里总是叮叮当当忙个不停。无论你是新入行的菜鸟，还是资深的专家，它都似乎永无休止。接下来是一些关于如何处理这些事情的主意。
...
我已经尽力让这篇文章变得**简练易读**，希望它是真的能有所启发而不是帮倒忙。文章总共分为四部分：**心态，学习，社会压力**和**工具箱**。来吧~~老弟~~。

[comment]: # (TODO: Add photo credits here)
...
## 心态
心态决定一切。人们会感到压力山大是因为手头一次性要处理的事情积压了太多，导致出现了过激反应，从而导致无法处理任何事情。你需要的是重新调整重心和优先级。
...
这是解决任何问题的第一步。**你为什么会觉得压力山大？**你问题的根源在哪里？同时要跟进的事情太多？工作责任太大？还是来自同辈的压力或者自我期望过高？
...
坐下来拿出纸笔，列出来你手头待办事项会对此有所帮助。如此以来你可以找出来那些最要紧的问题，从而进一步研究如何才能最好处理它们。
...
你不能每件事情都依靠自己来完成 - 这就是为什么我们会有团队的原因。样样精通是不可能的。术业有专攻，从人工智能，运维到层叠样式表，每个工程领域都有自己的专有知识。与之类似的，撰写教程，参与开源项目和开发课余项目都很费时间。没有啥事不费时间。
...
做事方法有好有坏，但是现实生活中却没有"绝对正确"的方法。解决方法并不是对的或错的，反而更像是最适合的。即使对于编程来说也是如此，甚至尤为突出。
...
**你到底想达成什么目标？**你是想成为世界上最优秀的容器化专家，还是只想在工作中得心应手，同时也可以回家陪伴家人？亦或是你想找到你的专属细分领域？你不必活在别人的世界里。心系目标可以让你**确立界限，专注于自己的野心并且意识到那些事情是与你无关的。**
...
身为程序员，我们大部分的知识储备都来源于自学 - 但是对于我们中的许多人来讲，这种学习方式还是相对比较新的。更重要的是，**没有人要求你记住所有的东西。**了解问题的范畴，以及到哪里寻找相关的资源更为重要。熟能生巧嘛。
...
自学之路上最大的障碍之一就是了解到底要学什么 - 从何学起，哪些是重点，以及有多少东西要学。没有课程表，所以**自己定义结构非常关键。**这样可以减轻要“女娲补天”的心理压力，还可以为以后逐条划掉增添动力。可以做一点探索性的研究来助你更好掌控它们；尝试如下：
...
- **程序员成长路线图**，类似于 Kamran Ahmed 整理的 [路线图](https://github.com/kamranahmedse/developer-roadmap)。 虽然这个路线图还是有非常多的内容，但是可以为你提供一些图形化的结构，并且帮你建立头绪。不过切记，没有人了解路线图中列出来的一切知识。
...
- **列一个你所不知道的知识清单**，每次你听到不熟悉的东西，都要更新此清单。你将会发现好多东西都是重复出现的。
...
- **网课和课程大纲** - 即使你不再是新手。你不一定非得学这门课，但你还是可以了解一下课程里面有哪些内容。
...
- **教材**。看似理所当然，但是实际上它们已经没有以前那么流行了。书本的内容经常可能会过期，但是还是可以帮你给课程范围起个头。
...
- **浏览招聘广告**来看下你属意的雇主们都在寻找那些技能。这样你可以了解当前哪些技能有需求，以及你是否在正确的职业之路上。如果有招聘广告中有你没听说的技术，那正好 - 补充到你的清单中，继续。
...
外面的资源太多了，但是并不是每个都有用或者准确。想想现在发表一篇文章有多么容易就知道了。**最有用的文章往往是那些在你最需要它们的时候找到的**，和那些恰好讨论与你在搜索的问题一模一样的。除此之外，还可以查找你的核心资源 - **那些你可以一再依赖的网站和专家**。以下是一些主要的类型： 
...
- **参考和学习资源**。有些网站花费了许多精力来整理实际项目中的最佳实践，并以最实用的方式将其展示出来。
...
- **专家**。有些人和博客作者对他们的细分领域了如指掌，还有人会写文章介绍一些关于新的和更好的做事方法。这些人很好找，因为他们的名字总是不时浮现，或者出现在搜索结果前排，或者他们好像写了好多你经常引用的文章。假如你刚进入一个新的领域，许多博客文章会由于过于深入，而让你感到困惑。但是假以时日，这些文章会促使你探索新的想法。
...
一旦有了自己的偏好，你就会发现你几乎再也不去查找其他地方了。不时走出自己的舒适区当然是好事，但是不要在你还在摸索的时候这么做。等你掌握差不多的时候再走出去。当你手头事情太多而不知所措时，可能会觉得手忙脚乱。但是当你进入舒适区以后，你会发现好像好多事情大同小异。
...
每周都预留出来一些时间来用于探索和学习。**不一定非得是什么大项目**，随便看看清单上的事项拿来熟悉熟悉。一个小时的学习就可以带来大为不同的效果。
...
- **用 [Pocket](https://getpocket.com/) 来暂存文章晚点读，而不是一直留在浏览器标签页上**，或者尝试先读半截再说。你可以随便给它们添加标注，以便于以后可以专心阅读。
...
- 有的时候只是上网搜一下，查找出定义就已经是巨大的进步了，还能帮你对事情有新的感悟。有些事情开始看起来很重要但是最后却没啥大不了的。
...
- **每次只关注一件事**。不要尝试一次性全部解决所有问题。花半小时学习某个特定的科目，并、并且正确理解它。
...
- **检查你的核心资源**。可能你使用的框架发布了一版更新，或者你会发现之前并不知道的新功能。
...
- **尝试新事物**。不用非得参加什么课程或者在工作中使用什么东西来理解它的要点，就是单纯为了好玩。随便试试。如果你从来没有用过 NoSQL，克隆一个 MongoDB 或者 Mongoose 种子项目来玩玩，一举三得。
...
有规律地做事可以**让事情变得值得期待**。你的通勤从此变成了阅读时间，星期天晚上则变成了你的周日实验之夜。并且你会从完成事情中感受到多巴胺的提高。
...
外面的世界，尤其是互联网上，总是有着各式各样的噪音。你很容易会觉得你什么都做不对。其实并不是这样的，你只是需要更多的视角。
...
正如好多人是蹩脚的作家，三流的歌手，或者数学不怎么样。拥有着两百万资金的初创公司可能会烂代码。谷歌的员工也可能写出烂代码。**甚至伟大的公司和程序员也可能会写烂代码**。我们能做的只能是勤加练习，并且不断学习。
...
没有人会愿意提起他们一直熬到凌晨两点修复一个简单的软件缺陷，或者他们在日常工作中纠缠于遗留代码的事实。他们更愿意讨论自己的业余项目，和试过的最新的酷炫小东西。**社交网络让人产生大家都在干着他们理想的工作的错觉**，但是实际上许多人都在加班加点赶截止日期，一直到深更半夜才离开公司。
...
有些人把事业当做重心，与此同时其他人会有其它不同的优先级和忙于生命中的其它事情。有人离了最新的技术活不了，有人则下定决心要做好自己的第二职业，还有人只想在社交网络中受欢迎。你不必和那些有时间就阅读最新博客文章的人攀比。等他们总结完你再看就好了。
...
人们喜欢写一些文章讨论那些是可能的，而不是最普遍的做法是什么。**好多东西日常中根本用不到**。仅仅因为某个技术很酷或者让人印象深刻，并不意味着你就一定要去用它。
...
职位广告似乎有着无穷无尽的条件要求，但是它们是人事部门照着完美候选人的情况写出来的。**有些列举的条件是必需的，但是剩下的常常是胡思乱想出来的**。有些是你在工作中可以学到的，有些是公司想要用但是还没有开始的，有些则只是存在于它们的五年路线图中。有些则只是占位关键词来吸引有近似技能的候选人：如果你知道 LESS （一种层叠样式表预处理器），那你也可以很快就学会与之类似的 Sass。
...
**有的时候你的经理并不了解工作的具体程度**。他们要么并不是很了解技术细节，要么他们的知识已经过时了。好多时候他们意识不到你不能“添加一个下拉列表”就好了，而是其实，需要添加一个带自动完成功能的选择模块，外加两个新的 API 路由。
...
规划好你的项目。管理好的任务。跟进你的软件漏洞。用git做版本控制。这些工具的存在是有原因 - 它们帮你跟进正在进行中的所有事情。你本来就不该把所有的东西都存在你渺小的人类大脑中。
...
- **使用良好的代码编辑器**。自动完成和工具提示定义等功能可以帮助你在编程时不用四处搜索代码库才知道发生了什么。
...
- **使用片段**。一个优秀的代码编辑器会允许你设置代码片段的快捷键，但是有的时候把文本放到文件里面存起来以便于复制粘贴也不失为一个好办法。如果你发现你自己一直在谷歌搜索同样的东西，那你可以把它放到你的片段文件中并添加注释，这样你就可以轻易找到了。
...
- **跟踪推理过程**。时不时的，你会发现自己在痛苦地调试代码，冥思苦想当初自己为什么要这么设计。反反复复尝试和理解同样的事情需要大量的认知开销。**为你的代码写文档**会帮助你节省时间和经理。
...
坐在房间里面连续十个小时盯着屏幕并不健康。你可能会纠缠于想象中的问题，从而**失去了对全局的掌控**。能够跳出自己的思考，和保持身体及大脑的健康都很重要。可以出门走走，哄哄狗狗，让你的眼睛休息一会。或者跟连 HTML 是什么都不知道的人聊聊天。
...
技术社区的人愿意助人为乐。这就是为什么他们会写文章，开发开源项目，以及询问你是否需要他们的支持。**索要好的资源和建议，或者寻求工作中需要的支持**。他们会乐意伸以援手的。
...
希望读到这里你已经看到了至少一个让你感到生活可以更可易掌控的主意。但是临别之际，我还有另外一个锦囊要赠予你，那就是：
